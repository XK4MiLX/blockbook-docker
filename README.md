...
|`BLOCKBOOK_PORT`| Port for blockbook <br /> Example: curl -sSL https://raw.githubusercontent.com/trezor/blockbook/master/configs/coins/flux.json | jq .ports.blockbook_public | `YES` | `unset` |
